...
class ExampleEndpoint extends Endpoint {
  ...
  Future<Article?> getArticleById(Session session, int id) async {
    return Article.findById(session, id);
  }

  Future<void> addArticle(Session session, Article article) async {
    return Article.insert(session, article);
  }

  Future<bool> updateArticle(Session session, Article article) async {
    return Article.update(session, article);
  }

  Future<int> deleteArticle(Session session, int id) async {
