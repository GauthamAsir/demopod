...
import 'auth_model_class.dart';
import 'example_class.dart';
import 'user_class.dart';

export 'article_class.dart';
export 'auth_model_class.dart';
...
class Protocol extends SerializationManagerServer {
  ...
  Protocol() {
    ...
    constructors['AuthModel'] = (Map<String, dynamic> serialization) =>
        AuthModel.fromSerialization(serialization);
    ...
    tableClassMapping['userdata'] = 'User';
